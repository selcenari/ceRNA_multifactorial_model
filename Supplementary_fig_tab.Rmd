...
```{r, message=FALSE, warning=FALSE, echo=FALSE, fig.width=5, fig.height=5, fig.show='hold', fig.cap = "Log2 transformed expression level of miR-30a-5p in tumor and normal tissue samples of 87 patients."}
