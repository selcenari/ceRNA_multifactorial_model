...
Interaction factors of Sample+ network are available in Table S1.
...
```{r, message=FALSE, warning=FALSE, echo=FALSE, fig.width=12, fig.height=5,fig.show='hold', fig.cap = "Tumor-specific perturbing nodes log2 transformed expression levels in tumor and normal tissue samples of 87 patients."}
