...
## *minsamp* dataset analysis at lack of interaction factors.
...
```{r, message=FALSE, warning=FALSE, out.width='50%', fig.asp=1, fig.ncol = 2, fig.show='hold', fig.cap = "Perturbation of Gene4 on minsamp data with interaction factors. a) Netwrk at steady-state. b) Upregulation of Gene4. c) Primary response of network to upregulation of Gene4. d) Re-regulation of whole nodes on system (3th iteration)"}
...
as.data.frame(E9GE_mirnagenenormal)%>%
 ...
 simulate(150) %>%
 find_iteration(limit=0, plot= TRUE) #limit=0 describes the change that is not taken into account.
```
