...
priming_graph(minsamp, 
  ...
  vis_graph(Competing_color = "navajowhite3", 
            mirna_color = "ivory4", 
            Upregulation = "red", 
            title = "Gene2 Upregulation\nwithout interaction factors")
```
...
priming_graph(minsamp, 
  ...
  vis_graph(Competing_color = "navajowhite3", 
            mirna_color = "ivory4", 
            title = "Minimal dataset with interaction\nfactors in steady-state conditions")
...
## Determination of optimum iteration for Upregulation of SERPINE2 gene from Breast cancer patient dataset
