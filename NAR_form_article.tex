...
as separate columns (see Figure S1 in Supplementary Tables). After
...
distribution of miRNA will be calculated accordingly. Target can be mRNA
or any other ceRNA (circRNA, ncRNA, etc.) thus, throughout the
manuscript terms target, gene and ceRNA are used interchangeably.
...
due to ``ripple effect'' (see Section 2 in Supplementary Materials and
Methods).
...
(see Section 3 in Supplementary Materials and Methods).
...
factors, efficiency of binding and repression have changed. On the other
hand, changes in expression levels of G4 and G1 differ although they
have same initial conditions (Detailed codes are available at Sections
3-4 in Supplementary Materials and Methods). This is due to fact that G4
is targeted by two miRNAs, M1 and M2 (Figures \ref{fig:fig3}D) and
changed interaction factors.
...
their perturbation efficiencies (Detailed codes are available at Section
4 in Supplementary Materials and Methods). On the other hand, when we
applied the method on the minimal dataset (i.e.~Gene4 is trigger
element), Gene4 has been found to be the most efficient element in terms
of number of perturbed elements and miRNA2 (M2) has been found to be
causing the highest mean in expression changes.
...
6.5 in Supplementary Materials and methods). With this approach, SERPINE
is found as one of the most effective gene nodes in network. We have
observed that the results of simulation with SERPINE2 gene, a serine
protease inhibitor, one of the overexpressed genes of breast cancer
