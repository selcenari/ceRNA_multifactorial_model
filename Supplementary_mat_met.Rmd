...
Please note that we have provided the hg18 liftover dataset under the data folder (lift18), in case of server errors/changes may occur. If you had problems generating lift18 data frame, please run the following code.
