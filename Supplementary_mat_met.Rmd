...
+ We committed the interaction factors as numeric values according to previous studies. (We added the interaction factors and their numeric values at Supplementary files, Process on miRNA:target pairs dataset for process codes and Supplementary Tables for used numeric values)
...
```{r}
#saveRDS(E9GE_mirnagenenormal, "data/E9GE_mirnagenenormal.rda")

E9GE_mirnagenenormal<-readRDS("data/E9GE_mirnagenenormal.rda")
...
```{r}
#saveRDS(E9GE_mirnagenetumor, "data/E9GE_mirnagenetumor.rda")

E9GE_mirnagenetumor<-readRDS("data/E9GE_mirnagenetumor.rda")
