...
clashelwak <- read.table(clash_url, comment.char = "#", header = TRUE, skip = 1, stringsAsFactors = FALSE)
...
read.table(mirbase_url, comment.char = "#")%>%
...
read_tsv(mirbase15_url, col_names = FALSE)%>%
