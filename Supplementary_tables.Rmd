...
\begin{tabular}{lll}
 ...
 Variable & Structure & Means \\
  \hline
   ...
   miRNA   & character & miRNA id (from miRBase vesion 21 ) \\
   ...
   Genom\_build   & character& Genom build of given chromosome, start and end positions \\
